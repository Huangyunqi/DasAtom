...
>>>>>>> Stashed changes
	...
	path_embeddings = "Data/{}/Rb2sq2Re4sq2/embeddings/".format(path_type)
	path_partitions = "Data/{}/Rb2sq2Re4sq2/partitions/".format(path_type)
	path_result = "results/yq_test/{}/Rb2sq2Re4sq2/".format(path_type)
	files = os.listdir(path)
	save_file_sub = True
	save_file_tot = True
	from_read = False
